...
![Check Main Branch](https://github.com/jeffreywallphd/OpenFinAL/blob/Dco_Update/documentation/images/check_branch.png)
...
![Branch Options](https://github.com/jeffreywallphd/OpenFinAL/blob/Dco_Update/documentation/images/branch_options.png)
...
![Branches](https://github.com/jeffreywallphd/OpenFinAL/blob/Dco_Update/documentation/images/branches.png)
...
![Branches Page](https://github.com/jeffreywallphd/OpenFinAL/blob/Dco_Update/documentation/images/branches_page.png)
![Create Branch Option](https://github.com/jeffreywallphd/OpenFinAL/blob/Dco_Update/documentation/images/create_branch.png)   
...
![Source Control](https://github.com/jeffreywallphd/OpenFinAL/blob/Dco_Update/documentation/images/Source_control.png)
* Step - 2 : Then you will be able to see below option in your side panel choose highlighted option:
![Three Dots](https://github.com/jeffreywallphd/OpenFinAL/blob/Dco_Update/documentation/images/three_dots.png)  
* Step - 3 : Then you will be able to see popup just like shown in below image and select pull option and you are good to go.
![Pull Option](https://github.com/jeffreywallphd/OpenFinAL/blob/Dco_Update/documentation/images/pull.png)
...
![Pull,Push Option](https://github.com/jeffreywallphd/OpenFinAL/blob/Dco_Update/documentation/images/pull_from.png)
...
![Branch Selection](https://github.com/jeffreywallphd/OpenFinAL/blob/Dco_Update/documentation/images/branch_select.png)
