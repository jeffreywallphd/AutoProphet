...
10. Open your command prompt by typing cmd .
      ...
      c. If you are not sure how to find and copy the file path this is how:
             Right click on the GitHub folder and select "copy as path" .
         ![image](https://github.com/jeffreywallphd/AutoProphet/assets/148374675/c383754a-63c0-4745-a8a0-1c7a57f8603a)
   
11. Next type in "cd auto-prophet" in the command prompt.
...
15. Lastly, type the following command "npm start"
...
17. After the startup finishes, you should see the desktop interface for the application.
